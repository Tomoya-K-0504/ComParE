...
def main(conf_key):
    ...
    complexities = [1e-4,1e-3,1e-2,1e-1,1e0, 1e1]
    ...
    for current_label in label_options:
        ...
        results_list.extend([uar_scores[np.argmax(uar_scores)], complexities[np.argmax(uar_scores)]])
...
if __name__ == '__main__':
    ...
    for conf_key in feat_conf.keys():
        devel_v_uar, v_C, devel_a_uar, a_C = main(conf_key)
        uar_list.append((devel_v_uar * 100, v_C, devel_a_uar * 100, a_C))
